...
new BeerSlider( document.getElementById( "slider1" ), { start: 25 } );

new BeerSlider( document.getElementById( "slider2" ), { start: 25 } );
...
const swiper = new Swiper('.swiper', {
	...
	breakpoints: {// РЅР°СЃС‚СЂРѕР№РєРё РґР»СЏ СЂР°Р·РЅС‹С… СЂР°Р·СЂРµС€РµРЅРёР№
		320: {
			slidesPerView: 1,
